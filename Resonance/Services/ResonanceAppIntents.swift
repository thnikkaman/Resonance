...
final class ResonanceAppIntentRuntime {
    ...
    func playSong(named name: String) async throws {
        ...
        throw ResonanceIntentError.notFound("I couldn't find the song \(name) in MeiKyo.")
    }
    ...
    func playAlbum(named name: String) async throws {
        ...
        throw ResonanceIntentError.notFound("I couldn't find the album \(name) in MeiKyo.")
    }
    ...
    func playArtist(named name: String) async throws {
        ...
        throw ResonanceIntentError.notFound("I couldn't find the artist \(name) in MeiKyo.")
    }
    ...
    func resumeAudiobook() async throws {
        ...
        guard !candidates.isEmpty else {
            throw ResonanceIntentError.notFound("I couldn't find a marked audiobook in MeiKyo.")
        }
...
private enum ResonanceIntentError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .runtimeUnavailable:
            return "MeiKyo is still starting. Please try again."
...
struct ResonanceMediaEntity: AppEntity, Identifiable, Sendable {
    ...
    static let typeDisplayRepresentation = TypeDisplayRepresentation(name: "MeiKyo media")
...
struct ResonancePlaySongIntent: AppIntent {
    ...
    static let description = IntentDescription("Play a song in MeiKyo.")
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        return .result(dialog: "Playing \(song.title) in MeiKyo.")
    }
}

struct ResonancePlayAlbumIntent: AppIntent {
    static let title: LocalizedStringResource = "Play Album"
    static let description = IntentDescription("Play an album in MeiKyo.")
    static let openAppWhenRun: Bool = true
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        return .result(dialog: "Playing \(album.title) in MeiKyo.")
    }
}

struct ResonancePlayArtistIntent: AppIntent {
    static let title: LocalizedStringResource = "Play Artist"
    static let description = IntentDescription("Play an artist in MeiKyo.")
    static let openAppWhenRun: Bool = true
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        return .result(dialog: "Playing \(artist.title) in MeiKyo.")
    }
}

struct ResonanceResumeAudiobookIntent: AppIntent {
    static let title: LocalizedStringResource = "Resume Audiobook"
    static let description = IntentDescription("Resume the most recently bookmarked audiobook in MeiKyo.")
    static let openAppWhenRun: Bool = true

    func perform() async throws -> some IntentResult & ProvidesDialog {
        try await ResonanceAppIntentRuntime.shared.resumeAudiobook()
        return .result(dialog: "Resuming your audiobook in MeiKyo.")
    }
}
