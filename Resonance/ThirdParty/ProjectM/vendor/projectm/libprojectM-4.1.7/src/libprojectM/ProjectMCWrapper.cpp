...
void projectm_opengl_set_target_framebuffer(projectm_handle instance, unsigned int framebuffer)
{
    auto projectMInstance = handle_to_instance(instance);
    projectMInstance->SetTargetFramebuffer(framebuffer);
}

void projectm_opengl_set_lyric_texture(projectm_handle instance,
                                       const unsigned char* rgba_pixels,
                                       int width,
                                       int height)
{
    handle_to_instance(instance)->SetLyricTexture(rgba_pixels, width, height);
}

void projectm_opengl_set_lyric_progress(projectm_handle instance, float progress)
{
    handle_to_instance(instance)->SetLyricProgress(progress);
}

void projectm_opengl_clear_lyric_texture(projectm_handle instance)
{
    handle_to_instance(instance)->ClearLyricTexture();
}
