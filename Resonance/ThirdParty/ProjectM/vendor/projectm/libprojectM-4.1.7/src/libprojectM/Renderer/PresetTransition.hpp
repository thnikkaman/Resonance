...
public:
    ...
    /** Starts the transition clock after the outgoing frame is safely presented. */
    void Restart();
...
private:
    ...
    bool m_hasRenderedFirstFrame{false}; //!< Keeps the first composite sample at the outgoing preset.
