    ...
    var body: some View {
        ...
        .toolbar {
            ...
            ToolbarItemGroup(placement: .topBarTrailing) {
                HStack(spacing: 4) {
                    ResonanceToolbarIconButton(
                        accessibilityLabel: "Scan MeiKyo Music folder",
...
struct ArtistCollectionView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            Text("Remove from Library keeps the audio files on your iPhone but hides them from MeiKyo. Delete from iPhone removes the files permanently.")
        }
