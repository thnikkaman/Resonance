            ...
            Form {
                ...
                Section("Artwork") {
                    ...
                    Button(role: .destructive) {
                        ...
                        Label("Remove Artwork in MeiKyo", systemImage: "photo.badge.minus")
                    }
                ...
                if library.hasMetadataOverride(track) {
                    Section {
                        ...
                        Text("This discards MeiKyo-only edits and rereads the original file tags.")
                    }
                }

                Section {
                        Text("Direct tag writing currently supports local FLAC and MP3 files. MeiKyo rereads the file after saving so the local library reflects the actual tags.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
            }
