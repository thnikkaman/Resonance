...
- Preserve build 63 (`0.3.7.4`, source commit `c3c1ebc`) as the current stability and rollback reference while implementing the next phase. Any new playback or Streaming work must retain its responsive tab switching, Library/Streaming/Settings navigation, Now Playing behavior, audio playback, and confirmed 5.1 gapless behavior.
